...
## Output
A phase breakdown that fits the `crew-planning` skill's `plans/<n>_<slug>/<id>-<title>.md` format (Spec head already exists; you produce the Plan body). Be specific: real file paths, real patterns to mirror. Do not write implementation code — produce the plan.
