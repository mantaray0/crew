...
const raw = {
  tags: [
    ...
    },
    {
      ...
      skills: ["shadcn-baseui"],
      rules: [],
    },
    {
      name: "tanstack",
      description: "TanStack Query/Form/Table",
      skills: ["tanstack-query", "tanstack-form", "tanstack-table"],
      rules: [],
    },
    {
      name: "bullmq-redis",
    ...
    {
      name: "bun",
      description: "Bun runtime/scripts",
      skills: ["bun-scripts"],
      rules: [],
    },
    {
